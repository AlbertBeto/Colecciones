 ...
 * -addCesta se le pasa un artículo y una cantidad. Primero comprobamos que artículo no sea null y la cantidad a
 comprar
 * sea mayor a 0, si no es mayor a 0 devuelvo 0.
 * Comprueba si ya lo he pedido, para actualizar esa cantidad si no lo añado con la cantidad que me pasan.
 * Devuelvo la cantidad que voy a comprar.
 * -ToString queremos que salga lo siguiente
 * "La cesta de la compra contiene X artículos.
 * Leche:1.99 7 uds compradas y el total de las uds por ejemplo 14.99
